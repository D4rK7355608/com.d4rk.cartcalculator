...
abstract class MainRepositoryImplementation(val application : Application , val dataStore : DataStore) {
    ...
    fun checkAndScheduleUpdateNotificationsImplementation(appUpdateNotificationsManager : com.d4rk.android.libs.apptoolkit.notifications.managers.AppUpdateNotificationsManager) {
        appUpdateNotificationsManager.checkAndSendUpdateNotification()
    }

    fun checkAppUsageNotificationsManagerImplementation(context : Context) {
        val appUsageNotificationsManager = com.d4rk.android.libs.apptoolkit.notifications.managers.AppUsageNotificationsManager(context = context)
