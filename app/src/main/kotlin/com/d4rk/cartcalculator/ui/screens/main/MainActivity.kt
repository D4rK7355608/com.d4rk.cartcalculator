...
class MainActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        with(receiver = viewModel) {
            ...
            configureSettings()
            viewModel.checkForUpdates(appUpdateManager = appUpdateManager , updateResultLauncher = updateResultLauncher)
    ...
    private fun initializeActivityComponents() {
        ...
        appUpdateNotificationsManager = com.d4rk.android.libs.apptoolkit.notifications.managers.AppUpdateNotificationsManager(context = this , channelId = "update_channel")
    }
