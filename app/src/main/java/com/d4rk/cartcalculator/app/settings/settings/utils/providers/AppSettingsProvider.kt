        ...
        return SettingsConfig(
            title = context.getString(com.d4rk.android.libs.apptoolkit.R.string.settings) , categories = listOf(
                ...
                SettingsCategory(
                    preferences = listOf(
                        SettingsPreference(
                            key = SettingsConstants.KEY_SETTINGS_CART , icon = Icons.Outlined.ShoppingCart , title = context.getString(R.string.cart_settings) , summary = context.getString(R.string.summary_preference_settings_cart) , action = {
                                GeneralSettingsActivity.start(
                                    context = context , title = context.getString(R.string.cart_settings) , contentKey = SettingsConstants.KEY_SETTINGS_CART
                                )
                            })
                    )
                ) ,
